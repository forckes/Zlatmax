...
//
//swiper
const thumbSwiper = new Swiper('.images-product__thumbs', {
    navigation: {
        nextEl: '.images-product__thumbs_arrow-next',
        prevEl: '.images-product__thumbs_arrow-prev',
      },
    observer: true,
...
const Imagesswiper = new Swiper('.images-product__slider', {
    navigation: {
        nextEl: '.images-product__slider_arrow-next',
        prevEl: '.images-product__slider_arrow-prev',
      },
    observer: true,
    observerParents:true, 
    slidesPerView: 1,
...
//
const Similarswiper = new Swiper('.similar-products__slider', {
    navigation: {
...
//.
const Recommendswiper = new Swiper('.recommend-products__slider', {
    navigation: {
        nextEl: '.recommend-products__arrow_next',
        prevEl: '.recommend-products__arrow_prev',
      },
    observer: true,
    observerParents:true, 
    slidesPerView: 4,
